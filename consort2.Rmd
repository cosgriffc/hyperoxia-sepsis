...
box_content[7] = "Study cohort \n n = 43,597"

# adjust the size of boxes to fit content
box_x <- c(0.20, 0.25, 0.25, 0.25, 0.25, 0.25, 0.20)
box_y <- c(0.07, 0.07, 0.07, 0.07, 0.07, 0.07, 0.07)
...
straightarrow(from = box_pos[1,], to = box_pos[7,], lwd = 1)
