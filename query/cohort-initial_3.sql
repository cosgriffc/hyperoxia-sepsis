...
(
SELECT hs.subject_id, hs.hadm_id, hs.icustay_id
    , hs.age, hs.gender, hs.icu_length_of_stay, hs.icustay_expire_flag
    , hs.hospital_expire_flag 
...
SELECT inc.subject_id, inc.hadm_id, inc.icustay_id, inc.age, inc.gender, inc.icu_length_of_stay, inc.icustay_expire_flag, inc.hospital_expire_flag
	, CASE
    	WHEN
        (
...
SELECT hs.subject_id, hs.hadm_id, hs.icustay_id
, hs.age, hs.gender, hs.icu_length_of_stay
, hs.hospital_expire_flag 
...
SELECT  co.subject_id, co.hadm_id, co.icustay_id, co.age, co.gender, co.icu_length_of_stay
...
SELECT co.subject_id, co.hadm_id, a.admittime, co.icustay_id, co.age, co.gender, co.icu_length_of_stay, co.vent_duration
, co.oasis, co.elixhauser, co.vasopressor_flag, co.hospital_expire_flag
, CASE WHEN (p.dod BETWEEN a.admittime AND (a.admittime + '365 day'::interval)) THEN 1
